...
cat << EOF >> ~/.zshrc
PATH="/usr/local/opt/node@18/bin:/usr/local/opt/coreutils/libexec/gnubin:/usr/local/opt/openjdk@17/bin:/usr/local/opt/ruby/bin:/usr/local/opt/gnu-sed/libexec/gnubin:\$PATH"
